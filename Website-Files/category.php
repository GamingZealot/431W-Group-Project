...
while ($row = mysqli_fetch_array($result)) {
 ...
 echo '<label id="' . $row['itemId'] . 's"></label><br>';
 echo '<label id="' . $row['itemId'] . 'r"></label><br>';
 echo '<label id="' . $row['itemId'] . 'u"></label><br>';
}
...
while ($row = mysqli_fetch_array($result)) {
	echo '<script type="text/javascript">document.getElementById("' . $row['itemId'] . 's").innerHTML = "Rental Price=' . $row['rentPrice'] . '"</script>';
}
...
while ($row = mysqli_fetch_array($result)) {
	echo '<script type="text/javascript">document.getElementById("' . $row['itemId'] . 's").innerHTML = "Current Bid=' . $row['currentBid'] . '"</script>';
}
