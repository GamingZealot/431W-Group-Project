...
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("American Beauty", 1999, "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRVe1Yp5UiKAVtuF30CFC1SyDO0bESwctM2v0cWPRThiagJUUgOC7kY0Q", "A sexually frustrated suburban father has a mid-life crisis after becoming infatuated with his daughter's best friend.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Aliens", 1986, "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQpeY0_GUlLdj9v7qlyonybPs6qXvM8L172FASdRp3nhkRzg-DmzsW0vg", "The moon from Alien (1979) has been colonized, but contact is lost. This time, the rescue team has impressive firepower, but will it be enough?");
...
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Oldboy", 2003, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBxjz7xqFFQsw5rfiuRS0zapLLWsBN4hH6FGA6da5VWBBMZXP3ntKHsg", "After being kidnapped and imprisoned for fifteen years, Oh Dae-Su is released, only to find that he must find his captor in five days.");
...
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Das Boot", 1981, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSflXwUPQKaOyOyHQ2LVJUtjIK-Kq9fj-zxSu93PYdewqWoLsphNLBRGg", "The claustrophobic world of a WWII German U-boat; boredom, filth, and sheer terror.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("North by Northwest", 1959, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtBbkf649aQoUMk-MmsaNmacc-xB9ehxA0A51PgbJD8mwg7ZlZr5vI6Q", "A hapless New York advertising executive is mistaken for a government agent by a group of foreign spies, and is pursued across the country while he looks for a way to survive.");
...
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Braveheart", 1995, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0cpZ-8tgWLVxq1XPj8Ro6WEDBhhEVK9NO6mqwly9sdsfzolkOqKdEPw", "When his secret bride is executed for assaulting an English soldier who tried to rape her, William Wallace begins a revolt against King Edward I of England.");
...
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Toy Story 3", 2010, "", "The toys are mistakenly delivered to a day-care center instead of the attic right before Andy leaves for college, and it's up to Woody to convince the other toys that they weren't abandoned and to return home.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Shawshank Redemption", 1994, "", "Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Godfather", 1972, "", "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Godfather: Part II", 1974, "", "The early life and career of Vito Corleone in 1920s New York is portrayed while his son, Michael, expands and tightens his grip on his crime syndicate stretching from Lake Tahoe, Nevada to pre-revolution 1958 Cuba.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Dark Knight", 2008, "", "When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, the caped crusader must come to terms with one of the greatest psychological tests of his ability to fight injustice.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("12 Angry Men", 1957, "", "A jury holdout attempts to prevent a miscarriage of justice by forcing his colleagues to reconsider the evidence.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Schindler's List", 1993, "", "In German-occupied Poland during World War II, Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazi Germans.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Pulp Fiction", 1994, "", "The lives of two mob hit men, a boxer, a gangster's wife, and a pair of diner bandits intertwine in four tales of violence and redemption.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Lord of the Rings: The Return of the King", 2003, "", "Gandalf and Aragorn lead the World of Men against Sauron's army to draw his gaze from Frodo and Sam as they approach Mount Doom with the One Ring.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Good, the Bad and the Ugly", 1966, "", "A bounty hunting scam joins two men in an uneasy alliance against a third in a race to find a fortune in gold buried in a remote cemetery.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Fight Club", 1999, "", "An insomniac office worker, looking for a way to change his life, crosses paths with a devil-may-care soap maker, forming an underground fight club that evolves into something much, much more.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Lord of the Rings: The Fellowship of the Ring", 2001, "", "A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save Middle Earth from the Dark Lord Sauron.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Star Wars: Episode V - The Empire Strikes Back", 1980, "", "After the rebels have been brutally overpowered by the Empire on their newly established base, Luke Skywalker takes advanced Jedi training with Master Yoda, while his friends are pursued by Darth Vader as part of his plan to capture Luke.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Forrest Gump", 1994, "", "Forrest Gump, while not intelligent, has accidentally been present at many historic moments, but his true love, Jenny Curran, eludes him.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Inception", 2010, "", "A thief, who steals corporate secrets through use of dream-sharing technology, is given the inverse task of planting an idea into the mind of a CEO.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Lord of the Rings: The Two Towers", 2002, "", "While Frodo and Sam edge closer to Mordor with the help of the shifty Gollum, the divided fellowship makes a stand against Sauron's new ally, Saruman, and his hordes of Isengard.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("One Flew Over the Cuckoo's Nest", 1975, "", "A criminal pleads insanity after getting into trouble again and once in the mental institution rebels against the oppressive nurse and rallies up the scared patients.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Goodfellas", 1990, "", "Henry Hill and his friends work their way up through the mob hierarchy.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Matrix", 1990, "", "A computer hacker learns from mysterious rebels about the true nature of his reality and his role in the war against its controllers.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Seven Samurai", 1954, "", "A poor village under attack by bandits recruits seven unemployed samurai to help them defend themselves.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Star Wars: Episode IV - A New Hope", 1977, "", "Luke Skywalker joins forces with a Jedi Knight, a cocky pilot, a wookiee and two droids to save the galaxy from the Empire's world-destroying battle-station, while also attempting to rescue Princess Leia from the evil Darth Vader.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("City of God", 2002, "", "Two boys growing up in a violent neighborhood of Rio de Janeiro take different paths: one becomes a photographer, the other a drug dealer.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("Se7en", 1995, "", "Two detectives, a rookie and a veteran, hunt a serial killer who uses the seven deadly sins as his modus operandi.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Silence of the Lambs", 1991, "", "A young F.B.I. cadet must confide in an incarcerated and manipulative killer to receive his help on catching another serial killer who skins his victims.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("It's a Wonderful Life", 1946, "", "An angel helps a compassionate but despairingly frustrated businessman by showing what life would have been like if he never existed.");
INSERT INTO Movies (title, year, pictureUrl, synopsis) VALUES ("The Usual Suspects", 1995, "", "A sole survivor tells of the twisty events leading up to a horrific gun battle on a boat, which begin when five criminals meet at a seemingly random police lineup.");
